...
Cube::Cube(int param1) { updateParams(param1); }
...
void Cube::makeTile(glm::vec3 topLeft, glm::vec3 topRight, glm::vec3 bottomLeft,
    ...
    glm::vec3 normal = glm::normalize(
        glm::cross((bottomLeft - topLeft), (bottomRight - bottomLeft)));
    ...
    normal = glm::normalize(
        glm::cross((bottomRight - topLeft), (topRight - bottomRight)));
...
void Cube::makeFace(glm::vec3 topLeft, glm::vec3 topRight, glm::vec3 bottomLeft,
    ...
    glm::vec3 unitHeightLength =
        (bottomLeft - topLeft) / glm::vec3(m_param1, m_param1, m_param1);
    glm::vec3 unitWidthLength =
        (topRight - topLeft) / glm::vec3(m_param1, m_param1, m_param1);
    glm::vec3 normal;
    glm::vec3 newTopLeft;
    ...
    for (int col = 0; col < m_param1; ++col) {
        for (int row = 0; row < m_param1; ++row) {
            ...
            newBottomLeft =
                topLeft +
                unitHeightLength * glm::vec3(row + 1, row + 1, row + 1) +
                unitWidthLength * glm::vec3(col, col, col);

            newBottomRight =
                topLeft +
                unitHeightLength * glm::vec3(row + 1, row + 1, row + 1) +
                unitWidthLength * glm::vec3(col + 1, col + 1, col + 1);
